...
The current official supervised private beta release is `v1.0.0-beta.100`,
codename **Config Belt**. It is feature-frozen unless a blocker,
...
- [v1.0.0-beta.100 release marker](docs/releases/v1.0.0-beta.100.md)
