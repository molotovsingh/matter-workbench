...
Current release checkpoint: [Matter Workbench v1.0.0-beta.10](docs/releases/v1.0.0-beta.10.md).
...
For the named-tester-account checkpoint and current private-VM release marker,
see [docs/releases/v1.0.0-beta.10.md](docs/releases/v1.0.0-beta.10.md).
