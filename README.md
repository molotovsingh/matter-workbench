...
Current release checkpoint: [Matter Workbench v1.0.0-beta.9](docs/releases/v1.0.0-beta.9.md).
...
see [docs/releases/v1.0.0-beta.9.md](docs/releases/v1.0.0-beta.9.md).
