...
The current official supervised private beta release is `v1.0.0-beta.99`,
codename **Fresh Badge**. It is feature-frozen unless a blocker,
...
- [v1.0.0-beta.99 release marker](docs/releases/v1.0.0-beta.99.md)
