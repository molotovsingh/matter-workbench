...
const ARTIFACT_LABELS = Object.freeze([
  ...
  [/Case Timeline\.md$/i, "Case Timeline"],
  [/Case Timeline\.json$/i, "Case Timeline data"],
  [/Case Timeline\.csv$/i, "Case Timeline spreadsheet"],
  [/Case Timeline Candidates\.json$/i, "Internal chronology candidates"],
