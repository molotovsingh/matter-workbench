...
export function renderConfigurableSkillRunOutput(result = {}) {
  ...
  return `
      ...
      <p class="muted">Generated by <code>${escapeHtml(skill.slash || runRecord.slash || "")}</code>. This slash command runs the latest approved version. Review before relying on it.</p>
...
export function renderConfigurableSkillRunRail(result = {}) {
  ...
  return `
        <section class="command-interview" aria-live="polite">
          ...
          <dl class="skill-card-meta">
            <div><dt>Slash command</dt><dd><code>${escapeHtml(skill.slash || runRecord.slash || "")}</code></dd></div>
...
export function renderConfigurableSkillExistingOutputSheetHtml(result = {}, pendingRun = {}) {
  ...
  return `
      <section class="command-interview" aria-live="polite">
        ...
        <dl class="skill-card-meta">
          <div><dt>Skill</dt><dd>${escapeHtml(skillName)} <code>${escapeHtml(slash)}</code></dd></div>
