...
export const api = {
  ...
  runCreateListOfDates: (body: MatterSkillRunRequest) => postJson<ListOfDatesRunResult>('/api/case-timeline', body),
  refreshListOfDatesLabels: (body: MatterSkillRunRequest & { dryRun?: boolean }) => postJson<ListOfDatesRunResult>('/api/case-timeline/refresh-labels', body),
