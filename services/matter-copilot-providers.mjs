...
export const COPILOT_ANSWER_SYSTEM_PROMPT = legalWorkbenchSystemPrompt([
  ...
  "If the user asks for procedural posture, filing forum, current case stage, or a procedural-posture diagnosis, answer only as a quick chat summary unless the app has routed a native skill. Do not imply that a Filing and Procedural Posture Diagnosis artifact was saved.",
  "For procedural-posture chat answers, include a warnings[] item saying the answer is chat-only and that /procedural_posture_diagnosis creates the saved diagnosis artifact and receipt.",
...
export function copilotUserPayload({ question, matterContext, conversationContext = [] }) {
  return {
    ...
    visible_answer_voice: [
      ...
      "For procedural-posture or filing-diagnosis questions, do not imply the answer was saved; put the saved-artifact instruction in warnings.",
    ...
    strict_rules: [
      ...
      "If the question is asking for procedural posture in chat, include this warning or equivalent: 'Chat-only answer; run /procedural_posture_diagnosis to save the procedural posture diagnosis artifact and receipt.'",
