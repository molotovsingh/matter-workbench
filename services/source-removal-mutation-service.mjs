...
export function buildRuntimeDbSourceRemovalMutationSql(input = {}) {
  ...
  return wrapRuntimeDbWriteTransaction([
    ...
    "  union all",
    "  select td.* from target_document td where not exists (select 1 from updated_document)",
    "), inserted_event as (",
    ...
    "  join selected_document sd on true",
    ...
    "  where exists (select 1 from selected_document)",
