...
Release: [`v1.0.0-beta.87`](releases/v1.0.0-beta.87.md)
...
`v1.0.0-beta.87` is the official private beta release checkpoint.
...
```text
release: v1.0.0-beta.87
codename: Provider Spine
deployed_commit: 0bb6420
