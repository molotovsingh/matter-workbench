...
Release: [`v1.0.0-beta.108`](releases/v1.0.0-beta.108.md)
...
`v1.0.0-beta.108` is the official private beta release checkpoint.
...
```text
release: v1.0.0-beta.108
codename: Watch Loom
deployed_commit: 49dae07
