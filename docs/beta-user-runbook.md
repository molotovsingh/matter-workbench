...
This runbook is for a supervised beta operator or developer helping a tester on the official `v1.0.0-beta.96` private beta release. It is not a public support manual and it is not a substitute for release notes.

## Before a session

1. Use the official release checkpoint: `v1.0.0-beta.96` / **Resume Thread**. Do not add new features during handoff prep.
