...
Generated at: 2026-06-05T08:09:17.718Z
Matched: yes
...
matter_totals:
  ...
  matter_artifacts: 28
  matter_import_batches: 15
  matter_import_items: 180
matter_summaries:
  Atlas Constuction vs Diptishree documents=9 extractions=9 source_descriptors=9 artifacts=2 import_batches=1 import_items=9 next_file_number=10
  Ayesha Vs Japan Airlines documents=34 extractions=34 source_descriptors=18 artifacts=2 import_batches=1 import_items=34 next_file_number=35
  Bharat Nagpal Vs Gionee India documents=14 extractions=14 source_descriptors=14 artifacts=2 import_batches=1 import_items=14 next_file_number=15
  Bose vs Atlas Realty - Contract Validity documents=4 extractions=4 source_descriptors=2 artifacts=2 import_batches=1 import_items=4 next_file_number=5
  Devi vs Patel Traders - Money Recovery documents=5 extractions=5 source_descriptors=3 artifacts=2 import_batches=1 import_items=5 next_file_number=6
  In re: Datacenter Logs - Evidence Triage documents=6 extractions=6 source_descriptors=0 artifacts=0 import_batches=1 import_items=6 next_file_number=7
  Iqbal vs Brightline Industries - Goods Supply documents=7 extractions=7 source_descriptors=5 artifacts=2 import_batches=1 import_items=7 next_file_number=8
  Kamran vs NCT documents=27 extractions=27 source_descriptors=8 artifacts=2 import_batches=1 import_items=27 next_file_number=28
  KK Taori vs Roma Builders documents=12 extractions=12 source_descriptors=12 artifacts=2 import_batches=1 import_items=12 next_file_number=13
  Krishnan vs Lumen Logistics - Service Recovery documents=8 extractions=8 source_descriptors=6 artifacts=2 import_batches=1 import_items=8 next_file_number=9
  Mehta vs Skyline documents=12 extractions=12 source_descriptors=10 artifacts=2 import_batches=1 import_items=12 next_file_number=13
  Nair vs Marlin Constructions - Boundary Dispute documents=7 extractions=7 source_descriptors=5 artifacts=2 import_batches=1 import_items=7 next_file_number=8
  Sharma vs Raheja Horizon - Possession Default documents=13 extractions=13 source_descriptors=11 artifacts=2 import_batches=1 import_items=13 next_file_number=14
  Techbeliever Vs GST documents=14 extractions=14 source_descriptors=14 artifacts=2 import_batches=1 import_items=14 next_file_number=15
  Verma vs Northstar Traders - Delivery Default documents=8 extractions=8 source_descriptors=8 artifacts=2 import_batches=1 import_items=8 next_file_number=9
...
storage_custody: ok
  checked_pdf_objects: 168
  missing_pdf_objects: 0
