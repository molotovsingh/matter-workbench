...
- renaming existing internal `10_Library/List of Dates.*` paths;
- deleting or changing `/create_listofdates` behavior;
...
| Term | Meaning |
| --- | --- |
| Case Timeline | Existing source-backed neutral chronology generated by `/create_listofdates`, displayed as Case Timeline. |
...
These remain the neutral Case Timeline source for MW LoD.
...
1. **Case Timeline Markdown and JSON**
   - Current internal path: `10_Library/List of Dates.*`.
...
```json
{
  ...
  "based_on": {
    "case_timeline": {
      "markdown_path": "10_Library/List of Dates.md",
      "json_path": "10_Library/List of Dates.json",
      "updated_at": "",
      "fingerprint": ""
    },
    "matter_story": {
...
8. Existing `/create_listofdates` / Case Timeline behavior remains unchanged.
