...
| Current release notes | [v1.0.0-beta.68](releases/v1.0.0-beta.68.md) |
...
| [v1.0.0-beta.68](releases/v1.0.0-beta.68.md) | Current Beta 3 archive confirmation backend hotfix release marker. |
