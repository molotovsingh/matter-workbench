...
| Current release notes | [v1.0.0-beta.26](releases/v1.0.0-beta.26.md) |
...
| [v1.0.0-beta.26](releases/v1.0.0-beta.26.md) | Current Beta 3 upload failure hardening release marker. |
