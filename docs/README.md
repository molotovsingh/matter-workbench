...
| Current release notes | [v1.0.0-beta.88](releases/v1.0.0-beta.88.md) |
...
| [v1.0.0-beta.88](releases/v1.0.0-beta.88.md) | Current AI task model-policy metadata refactor. **Codename:** Policy Spine. |
