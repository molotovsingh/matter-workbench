...
| Current release notes | [v1.0.0-beta.49](releases/v1.0.0-beta.49.md) |
...
| [v1.0.0-beta.49](releases/v1.0.0-beta.49.md) | Current Beta 3 Skill Factory sample warning cleanup release marker. |
