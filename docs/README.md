...
| Current release notes | [v1.0.0-beta.67](releases/v1.0.0-beta.67.md) |
...
| [v1.0.0-beta.67](releases/v1.0.0-beta.67.md) | Current Beta 3 visible matter archive confirmation hotfix release marker. |
