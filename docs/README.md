...
| Current release notes | [v1.0.0-beta.99](releases/v1.0.0-beta.99.md) |
...
| [v1.0.0-beta.99](releases/v1.0.0-beta.99.md) | Current runtime config freshness fix. **Codename:** Fresh Badge. |
