...
| Current release notes | [v1.0.0-beta.77](releases/v1.0.0-beta.77.md) |
...
| [v1.0.0-beta.77](releases/v1.0.0-beta.77.md) | Current Beta 3 tester What’s new notice release marker. **Codename:** Notice Bell. |
