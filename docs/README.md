...
| Current release notes | [v1.0.0-beta.33](releases/v1.0.0-beta.33.md) |
...
| [v1.0.0-beta.33](releases/v1.0.0-beta.33.md) | Current Beta 3 Copilot interaction receipts release marker. |
