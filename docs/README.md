...
| Current release notes | [v1.0.0-beta.39](releases/v1.0.0-beta.39.md) |
...
| [v1.0.0-beta.39](releases/v1.0.0-beta.39.md) | Current Beta 3 draft skill title cleanup release marker. |
