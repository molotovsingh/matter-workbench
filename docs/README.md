...
| Current release notes | [v1.0.0-beta.34](releases/v1.0.0-beta.34.md) |
...
| [v1.0.0-beta.34](releases/v1.0.0-beta.34.md) | Current Beta 3 Copilot thread-helper hardening release marker. |
