...
| Current release notes | [v1.0.0-beta.113](releases/v1.0.0-beta.113.md) |
...
| [v1.0.0-beta.113](releases/v1.0.0-beta.113.md) | Current native procedural posture diagnosis skill. **Codename:** Posture Compass. |
