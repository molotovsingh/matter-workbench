...
| Current release notes | [v1.0.0-beta.75](releases/v1.0.0-beta.75.md) |
...
| [v1.0.0-beta.75](releases/v1.0.0-beta.75.md) | Current Beta 3 long-wait progress UX release marker. |
