...
| Current release notes | [v1.0.0-beta.48](releases/v1.0.0-beta.48.md) |
...
| [v1.0.0-beta.48](releases/v1.0.0-beta.48.md) | Current Beta 3 Skill Factory OpenRouter default release marker. |
