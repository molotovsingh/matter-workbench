...
| [v1.0.0-beta.119](releases/v1.0.0-beta.119.md) | Document-style Markdown page frame. **Codename:** Page Frame. |
| [v1.0.0-beta.120](releases/v1.0.0-beta.120.md) | Consistent Markdown body typography. **Codename:** Type Rule. |
