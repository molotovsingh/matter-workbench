...
Status: Current checklist for `v1.0.0-beta.79` official supervised private beta release
...
[Matter Workbench v1.0.0-beta.79](releases/v1.0.0-beta.79.md)
